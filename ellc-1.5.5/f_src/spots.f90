...
! Occuting ellipse intersects tangent ellipse at two points and is completely
! inside the circle
if (btest(flag_c, b_ell_ellipse_inside_circle).and. &
    btest(flag_s, b_ell_two_intersects) ) then
...
! the plane of the sky, as the coordinates of the tangent points of this
! ellipse with the projected limb of the star for stars on the limb.
!
